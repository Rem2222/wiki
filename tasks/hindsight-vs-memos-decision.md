...
MemOS сильнее по многослойности (L1/L2/L3) и встроенному dsh-плагину, но dsh у Романа вторичен; к Hindsight dsh-плагин накидывается по EverOS-рецепту (см. [[concepts/memory-retrieve-middleware]]).
