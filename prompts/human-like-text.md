---
description: Промт для LLM, чтобы она писала текст как человек и проходила проверку на ИИ. Оригинал с Telegraph: Нейродвиж. Содержит роль, цель, требования, рекомендации по улучшению текста и структурные элементы.
tags: [prompts, llm, writing, ai-detection]
related: [humanizer skill]
---

# Промт: человеческий текст + прохождение AI-детекции

**Источник:** [telegra.ph/Promt-06-11-2](https://telegra.ph/Promt-06-11-2)  
**Автор:** Нейродвиж
